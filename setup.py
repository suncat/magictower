...
class BuildExe:
    def __init__(self):
        ...
        # 起始py文件
        self.script = "magictower.py"
        # 游戏名
        self.project_name = "Magic Tower"
        # 游戏site
        self.project_url = "about:none"
        # 游戏版本
        self.project_version = "0.0"
        # 游戏许可
        self.license = "Magic Tower License"
        # 游戏作者
        self.author_name = "Hong Xingjian"
        # 联系电邮
        self.author_email = "cleverest_hongxj@163.com"
        # 游戏版权
        self.copyright = "Copyright (c) 3000 Hong Xingjian."
        # 游戏描述
        self.project_description = "Magic Tower Description"
        # 游戏图标(None的话使用pygame的默认图标)
        self.icon_file = None
        # 额外需要拷贝的文件、文件夹(图片，音频等)
        self.extra_datas = ["dead.aif", "Michael_Jackson_-_Billie_Jean.ogg"]
        self.extra_datas.extend(glob.glob("*.png"))
        # 额外需要的python库名
